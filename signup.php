...
<div style="width:41%;height:500px;background-color:#ededea;margin-left: 401px;margin-top: 61px;border:1px solid #a5a59f;border-top: 6px solid #eae66b;">
	...
	<input style="width:301px;height:35px;margin-left: 115px;margin-top: 41px;border-radius: 4px " type="text" name="id" placeholder=" Enter User Id"><br>
	<input style="width:301px;height:35px;margin-left: 115px;margin-top: 41px;border-radius: 4px " style="width:201px;height:25px " type="Password" name="ps" placeholder=" Enter New Password"><br>
	<input style="width:301px;height:35px;margin-left: 115px;margin-top: 41px;border-radius: 4px " style="width:201px;height:25px " type="text" name="email" placeholder=" Enter Email"><br>
